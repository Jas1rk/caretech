    ...
    <>
      <Router>
        <Routes>
          ...
          <Route path="/booking-history" element={<IsUser><BookingHistoryView/></IsUser>}/>
          ...
          <Route path="/doctor/booking-details" element={<IsDoctor><DoctorUsersBookingDetails/></IsDoctor>}/>
